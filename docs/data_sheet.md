Data set name: PMST Khoirentak Kom

Data set developer(s): Susie Kanshouwa, Sandra Auderset, Antonia Pauly

Data sheet author(s): Susie Kanshouwa, Sandra Auderset

Others who contributed to this document: K. Grace Kom, Karong Reneikip Kom, Hmunkhunei Serto
...
This data set was created to investigate the dynamics of person marking in Khoirentak Kom and other South-Central Trans-Himalayan languages.
...
For Khoirentak, it is a version of the community orthography used by speakers.

**How many instances are there in total?**

* Number of inflected forms: 242
* Number of unique inflected forms: 147
...
|paradigm |variants_tag |overabundance_tag |analysis_tag   |  n|
|:--------|:------------|:-----------------|:--------------|--:|
|pron     |unspecified  |                  |               |  7|
|fut.aff  |dialect_var  |                  |               | 11|
|fut.aff  |unspecified  |optional_future   |               |  1|
|fut.aff  |unspecified  |                  |               | 39|
|fut.neg  |dialect_var  |                  |mult_exponence |  4|
|fut.neg  |dialect_var  |                  |               | 20|
|fut.neg  |formal       |                  |mult_exponence | 11|
|fut.neg  |informal     |                  |fusion         |  9|
|fut.neg  |informal     |                  |               |  2|
|fut.neg  |unspecified  |optional_plural   |               |  1|
|fut.neg  |unspecified  |                  |               | 28|
|nfut.aff |dialect_var  |                  |               |  9|
|nfut.aff |unspecified  |optional_plural   |               |  1|
|nfut.aff |unspecified  |                  |               | 39|
|nfut.neg |dialect_var  |                  |               | 20|
|nfut.neg |formal       |                  |               |  1|
|nfut.neg |informal     |                  |fusion         |  1|
|nfut.neg |unspecified  |optional_plural   |               |  2|
|nfut.neg |unspecified  |                  |               | 38|
...
* Glottocode: komi1270
* Language variety description: This variety is spoken in Khoirentak village, located in Bishnupur district of Manipur in northeast India. The Glottocode refers to Kom in general, not specifically to Khoirentak Kom.

**Does the data pertain to specific dialects, geographical locations, genre, etc?**

The data was collected from Khoirentak village. There are six regional varieties in Kom: Mongtung variety, Sinamkom variety, Moirang variety, Mantak variety, Sagang variety, and Tonsen variety. Khoirentak belongs to the Moirang variety.
...
K. Grace Kom: native speaker (language consultant cum field assistant)

Karong Reneikip Kom, Hmunkhunei Serto: native speakers (language consultants)
...
The data was collected predominantly between October and December 2025.
