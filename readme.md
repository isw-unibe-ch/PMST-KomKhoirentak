# Person Marking in South-Central Trans-Himalayan: Khoirentak Kom

This PARALEX set contains person markers in Khoirentak Kom, including inflected verbal forms and pronouns. It constitutes part of the PMST (Person Marking in South-Central Trans-Himalayan) database.
...
## Additional information specific to Khoirentak Kom

* Tone: Tone is unmarked, as tonal analysis is still pending.
* Mapping between database paradigm labels and Khoirentak descriptive labels based on Aimol 2007:
...
a) colloquial (spoken/informal/fast speech) vs. formal (written/formal/slow speech):

    (1) nuŋ vs. niŋ-uŋ in 1>2/3 future negative constructions
    (2) tun vs. tin-chui in 2>1/3 and 3SG>2PL future negative constructions
b) na- / nan- vs. nani- in 2>1/3 future and non-future affirmative constructions
c) an- vs. ani- in 3>1 (and 2>1) future and non-future affirmative constructions
d) optional plural in 3PL>2 negative constructions
e) free variation between the 1SG/1PL object markers a- and ei- in 2/3>1 negative constructions
